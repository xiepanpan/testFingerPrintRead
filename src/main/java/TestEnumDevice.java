 ...
 * @Description:
 */
public class TestEnumDevice {
    private static Logger logger = LoggerFactory.getLogger(TestEnumDevice.class);
    ...
    public static void main(String[] args) {
        ...
        //5. 指纹转成特征值
        ByteBuffer pFeature = null;
        try {
            ByteBuffer pImage= ByteBuffer.wrap(by);
            pFeature = ByteBuffer.wrap(new byte[256]);
        ...
        short uRotate = 60;
        short uLevel = 5;
        ByteBuffer pFeature2 = ByteBuffer.wrap(datas);
        try {
            long matchReturnCode = D5Match(pFeature, pFeature2, uRotate, uLevel);
    ...
    private static byte[] fileToByteArray(String s) {
        //创建源与目的地
        File src = new File("E:\\1.fea");//获得文件的源头，从哪开始传入(源)
